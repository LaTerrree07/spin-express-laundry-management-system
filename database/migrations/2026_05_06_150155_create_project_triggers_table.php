...
return new class extends Migration
{
    ...
    {
        DB::unprepared("DROP TRIGGER IF EXISTS trg_before_insert_transactions");
        DB::unprepared("DROP TRIGGER IF EXISTS trg_before_insert_transaction_extra_items");
        DB::unprepared("DROP TRIGGER IF EXISTS trg_before_insert_payments");
    }
};