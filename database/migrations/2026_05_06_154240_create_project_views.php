...
return new class extends Migration
{
    ...
    {
        // Drop old unused views first
        DB::statement("DROP VIEW IF EXISTS vw_transaction_details");
        DB::statement("DROP VIEW IF EXISTS vw_payment_details");

        // Drop active views before recreating
        DB::statement("DROP VIEW IF EXISTS vw_customer_transaction_records");
        DB::statement("DROP VIEW IF EXISTS vw_service_category_records");
        DB::statement("DROP VIEW IF EXISTS vw_transaction_extra_items");
