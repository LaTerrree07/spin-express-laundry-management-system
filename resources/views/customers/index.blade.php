<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-xl font-semibold text-[#1E293B]">Customers</h2>
    ...
    <div class="space-y-6">
        <div class="rounded-2xl border border-[#D6DEE8] bg-white p-4 shadow-sm">
            <form method="GET" action="{{ route('customers.index') }}" class="flex flex-col gap-3 sm:flex-row">
    ...
    <div class="flex justify-end gap-2">
        ...
        @endif
            ...
            @include('layouts.partials.table-pagination', ['paginator' => $customers])
        </div>
    </div>
</x-app-layout>